/**
 * Client-side API methods for classroom-timemachine
 */
...
const FEATURE = 'classroom-timemachine';

/**
 * classroom-timemachine API client with standardized paths
 */
export const classroom-timemachineApi = {
  /**
