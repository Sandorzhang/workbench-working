/**
 * Client-side API methods for teaching-design
 */
...
const FEATURE = 'teaching-design';

/**
 * teaching-design API client with standardized paths
 */
export const teaching-designApi = {
  /**
