...
export default function VerticalTimeline({
    ...
    return (
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-500 text-sm">教学时间线将在这里显示</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div
      ref={viewportRef}
      className="bg-white rounded-2xl shadow-sm border border-gray-100 h-full flex flex-col"
    >
      {/* 时间线标题 */}
              ...
              width: timelineRef.current
                ? `${
                    (viewportPosition /
                      Math.max(
                        1,
                        timelineRef.current.scrollHeight - timelineHeight
                      )) *
                    100
                  }%`
                : "0%",
      ...
      {/* 主时间线区域 */}
      <ScrollArea ref={timelineRef} className="flex-1 overflow-hidden">
                        ...
                        >
                          ...
                          <Card
                            className={cn(
                              ...
                              `bg-gradient-to-br ${getSubjectGradient(
                                moment.subject
                              )}`
                            )}
