...
interface StudentDetail {
  ...
  academicRecords: Array<{id: string; subject: string; score: number; date: string; type: string; rank: string; comment: string}>;
}
...
export const teacherHandlers = [
      ...
      notes: [
        {
            id: '1',
            date: '2023-05-15',
            content: '张明在数学学科表现出色，特别是在代数方面。他对编程也表现出很强的兴趣，建议可以引导他参加相关的编程竞赛。',
          author: '李老师'
        },
        {
            id: '2',
            date: '2023-04-20',
            content: '最近的小组项目中，张明展示了良好的团队合作能力，能够帮助其他同学解决问题。但在时间管理方面还需要提高。',
          author: '李老师'
        },
        {
            id: '3',
            date: '2023-03-10',
            content: '期中考试后与张明进行了辅导，他在化学科目上有些困难，已提供了一些学习方法和资源。',
            author: '李老师'
          }
        ],
        academicRecords: [
        ...
        notes: [
          {
            id: '1',
            date: '2023-05-20',
            content: '李华在英语和艺术课程表现优秀，特别是口语表达能力很强。建议可以参加英语演讲比赛。',
            author: '李老师'
          },
          {
            id: '2',
            date: '2023-04-25',
            content: '李华在团队项目中展现了良好的创意能力，但需要提高数学逻辑思维。建议增加相关练习。',
          author: '李老师'
        }
        ],
        academicRecords: [
  ...
  // 更新学生笔记
  http.post('/api/teacher/student/:studentId/notes', async ({ params, request }) => {
