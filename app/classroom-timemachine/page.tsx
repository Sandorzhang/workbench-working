          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>课堂时光机</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
            ...
            {selectedRecord ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {mockClassRecords.map((record) => (
                  <div 
                    key={record.id} 
                    className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden cursor-pointer transition-all duration-300 transform hover:-translate-y-1 hover:shadow-md"
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm">{record.teacher}</span>
                        </div>
