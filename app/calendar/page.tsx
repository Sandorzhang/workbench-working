    ...
    try {
      ...
      if (Array.isArray(data)) {
        ...
        if (selectedDate) {
          ...
          const eventsForSelectedDate = data.filter(
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mb-6 px-1">
        <div className="flex items-center space-x-4">
          ...
          <Badge
            variant="outline"
            className="text-sm font-normal animate-fadeIn"
          >
            {events.length} 个事件
          </Badge>
          {isRefreshing && (
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button variant="outline" onClick={goToToday} disabled={isRefreshing}>
            今天
          </Button>
          <Button
            variant="outline"
              ...
              <div className="grid grid-cols-7 text-center py-3 bg-muted/10 border-b">
                {["日", "一", "二", "三", "四", "五", "六"].map(
                  (day, index) => (
                    <div
                      key={index}
                      className="py-1.5 text-sm font-medium text-muted-foreground"
                    >
                      {day}
                    </div>
                  )
                  ...
                  >
                    <div className="flex justify-between items-start mb-1">
                      ...
                      {hasEvents(day.date) && (
                        <Badge
                          variant="outline"
                          className="text-[10px] px-1.5 py-0.5 font-medium bg-background/80"
                        >
